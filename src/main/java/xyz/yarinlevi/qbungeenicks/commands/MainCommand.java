...
import xyz.yarinlevi.qbungeenicks.utils.CommandCooldownUtils;
...
public class MainCommand extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (CommandCooldownUtils.isCooldown(player)) {
            player.sendMessage(new TextComponent("Please wait a bit before doing that."));
            return;
        } else {
            CommandCooldownUtils.addCooldown(player);
        }
        ...
        if (args.length == 1) {
            if (args[0].equalsIgnoreCase("reset")) {
                ...
                if (player.hasPermission("qbungeenicks.vip.1")) {
                ...
                if (player.hasPermission("qbungeenicks.vip.3")) {
                    String nick = args[0];
            ...
            if (player.hasPermission("qbungeenicks.vip.2")) {
                ...
                player.sendMessage("You do not have permission to select a nick.");
            }
        }
    }
}
